...
$script.= 'jQuery(document).ready(function(){jQuery("form#'.$id.'").simpleform({url:"'.JURI::root().'modules/mod_simpleform2/engine.php",loaderImg:"'.JURI::root().'modules/mod_simpleform2/images/loading.gif",'.($userFunc!=''?'checkCallBack:'.$userFunc.',':'').($userResultFunc!=''?'resultCallBack:'.$userResultFunc.',':'').'});});';
